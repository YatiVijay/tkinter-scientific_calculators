...
class calculator:
    def __init__(self):
        ...
        window.configure(background="#000000")  #window background
        ...
        #creating frame for functions button
        text=1
        i=0
        row=1
        col=0
    ...
    #append charater to create equation
    def addChar(self,char):
        self.string.set(self.string.get()+(str(char)))
        
    #delete single charater
    def delete(self):
        self.string.set(self.string.get()[0:-1])
        
#call function to get the GUI-calculator
calculator()
